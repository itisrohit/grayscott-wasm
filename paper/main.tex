...
WebAssembly and runs it inside a module Web Worker. Table~\ref{tab:browserinv}
shows automated HeadlessChrome 147 timings for the default clean inverse target.
Timing starts after worker-side WebAssembly initialization and includes the
exported optimizer call plus worker-side JSON parsing.
...
\hline
\(32^2\) & 21 & 22.200 & 2.467 & 1.057\\
\(64^2\) & 17 & 68.000 & 7.556 & 4.000\\
\(96^2\) & 17 & 142.800 & 15.867 & 8.400\\
\hline
\end{tabular}
\end{table}

These timings demonstrate that the full inverse loop runs in the browser path
without blocking the main page during the optimizer call. They should be
interpreted as local engineering measurements rather than cross-browser
performance claims.
...
machine. Interactive and cross-browser measurements are left to future work.
